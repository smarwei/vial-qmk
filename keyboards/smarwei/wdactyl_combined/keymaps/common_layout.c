...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_std(
        ...
        KC_TAB,  KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,        KC_J,    KC_L,    TD(TD_UE),KC_Y,     TT(3),    KC_F24,
        KC_ESC,  TD(TD_AE),KC_R,     TD(TD_SS),KC_T,     KC_G,        KC_M,    KC_N,    KC_E,     KC_I,     TD(TD_OE),KC_CAPS,
        CAPSWRD, KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,        KC_K,    KC_H,    KC_COMM,  KC_DOT,   KC_SLASH, TT(3),
                           KC_LGUI,  KC_LALT,                                           KC_MINS,  KC_EQL,

                                     MO(1),   KC_LCTL,  KC_LGUI,      KC_LALT, KC_SPACE,  MO(2),
