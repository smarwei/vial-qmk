...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_std(
        RESET,   KC_Q,    KC_W,     KC_F,    KC_P,     KC_B,        KC_J,    KC_L,    KC_U,    KC_Y,     KC_SCLN,  KC_F24,
        RESET,   KC_A,    KC_R,     KC_S,    KC_T,     KC_G,        KC_M,    KC_N,    KC_E,    KC_I,     KC_O,     KC_CAPS,
        RESET,   KC_Z,    KC_X,     KC_C,    KC_D,     KC_V,        KC_K,    KC_H,    KC_COMM, KC_DOT,   KC_SLASH, KC_RSFT,
                          KC_LGUI,  KC_LALT,                                          KC_MINS, KC_EQL,

                                           MO(1),    KC_LSFT,       KC_SPACE,TD(0),
                                                     KC_LSFT,       KC_ENT
